...
export { Synth, Sample, Theremin, Sax, Arp, SubSynth, FMSynth } from './instruments.js'
export { Kick, Snare, HiHat, Kick808, Kick909, Hihat808, Snare909 } from './percussion.js'
export { Bass303, Pad, Pluck, Stab, Rhodes, Wurlitzer, Hammond, Clavinet, DX7Lead, WavetableSynth, SuperSaw, KarplusSynth, Guitar, AcousticGuitar, BassGuitar, Trumpet, Trombone, FrenchHorn, Flugelhorn } from './melodic.js'
